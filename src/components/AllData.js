...
import Img20 from "../img/products/cosmic_byte_keyboard.jpg";
import Img21 from "../img/products/Lenovo-Legion-5i.webp";
import Img22 from "../img/products/Predator-Helios-Neo-16.jpg";
import Img23 from "../img/products/officechair.webp";
...
import cosmic_byte1 from "../img/products/otherProducts/cosmic_byte_keyboard1.jpg";
import cosmic_byte2 from "../img/products/otherProducts/cosmic_byte_keyboard2.jpg";
...
import Lenovo1 from "../img/products/otherProducts/LenovoLegion1.jpg";
import Lenovo2 from "../img/products/otherProducts/LenovoLegion2.jpg";
import acerPredator1 from "../img/products/otherProducts/acerPredator1.webp";
import acerPredator2 from "../img/products/otherProducts/acerPredator2.jpg";
import chair1 from "../img/products/otherProducts/chair1.webp";
import chair2 from "../img/products/otherProducts/chair2.webp";
...
export const items = [
  ...
  },
  {
    ...
    category: "electronic",
    img: Img20,
    description: "Cosmic Byte CB-GK-06 Wired Keyboard",
    price: 2800,
    otherImgs: [cosmic_byte1, cosmic_byte2],
    specs:
      "The Cosmic Byte CB-GK-06 Galactic Wired Gaming Keyboard designed for gaming enthusiasts. It comes with an aluminium body that ensures durability and longevity. The keyboard is equipped with a 7-color RGB backlight that can be adjusted to 4 different brightness levels and offers 9 backlight effects. The keys are scratch-resistant and easy to clean, ensuring long-lasting performance. ",
    texture: "white",
    weight: "	1.5 kg",
    size: "53 × 23 × 4 cm",
  },
  {
    ...
    category: "electronic",
    img: Img21,
    description: "Lenovo Legion 5i Pro 16",
    price: 139790,
    otherImgs: [Lenovo1, Lenovo2],
    specs:
      " The Lenovo Legion 5i Pro 16 is a high-performance gaming laptop that comes with an 11th Generation Intel® Core™ i7-11800H Processor with a base clock speed of 2.30 GHz and a maximum boost clock speed of 4.60 GHz. It has 8 cores, 16 threads, and 24 MB cache. The laptop runs on the latest Windows 11 Home operating system. 1TB M.2 2280 SSD. display 16-inch QHD (2560 x 1600) IPS 165Hz, 500 nits, and Dolby Vision HDR 400 support. 32 GB DDR4 RAM . battery up to 7Hr.",
    texture: "Grey",
    weight: "	2.3 kg",
    size: "16 inch",
  },
  {
    ...
    price: 121450,
    otherImgs: [acerPredator1, acerPredator2],
    specs:
      " The Acer Predator Helios Neo 16 is a gaming laptop that is powered by an Intel® Core™ i7-13700HX processor, NVIDIA® GeForce RTX™ 4060 8GB GDDR6 (MGP: 140W) graphics, 16 GB DDR5 4800Mhz Memory and a 1TB PCIe NVMe Gen 4 SSD. It has a 40.6 cm (16) 165Hz display and weighs 2.6 kg. The laptop has 2 x Thunderbolt 4, 3 x USB-A 3.2, HDMI 2.1, Micro SD card slot, Ethernet port, 3.5 mm combo jack, and Kensington lock.",
    texture: "Black",
    weight: "	2.6 kg",
    size: "16 inch",
  },
  {
    ...
    specs:
      " Upgrade your workspace with our Ergonomic Office Chair, designed to provide the perfect blend of style, comfort, and functionality. Whether you're working from home or at the office, this chair will enhance your productivity and keep you comfortable throughout the day.",
    texture: "Black",
    weight: "	18  kg",
    size: "L 1.1m x W 68.5cm x H 68.5cm ",
  },
];
